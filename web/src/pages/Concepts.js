...
const Icon = {
    ...
    trash: (_jsxs("svg", { viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", children: [_jsx("path", { d: "M3 6h18" }), _jsx("path", { d: "M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2" }), _jsx("path", { d: "M19 6l-1 14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2L5 6" }), _jsx("path", { d: "M10 11v6" }), _jsx("path", { d: "M14 11v6" })] })),
};
...
function CreateConceptModal({ typeNames, busy, onClose, onSubmit }) {
    ...
    const handleGenerate = async () => {
        ...
        try {
            ...
            if (firstType) {
                if (typeNames.includes(firstType))
                    setConceptType(firstType);
                if (!name)
                    setName(firstType);
                if (firstDef?.description && !description)
                    setDescription(firstDef.description);
            }
            else {
    ...
    return (_jsx("div", { className: "modal-backdrop", onClick: onClose, children: _jsxs("div", { className: "modal", role: "dialog", "aria-modal": "true", "aria-labelledby": "create-concept-title", onClick: (e) => e.stopPropagation(), children: [_jsxs("div", { className: "modal-head", children: [_jsx("h3", { id: "create-concept-title", children: "Create Concept" }), _jsx("button", { className: "modal-close", onClick: onClose, "aria-label": "Close", children: "\u00D7" })] }), _jsxs("div", { className: "modal-section", children: [_jsx("label", { className: "modal-label", children: "Generate with AI from a prompt" }), _jsx("textarea", { className: "modal-input", rows: 2, placeholder: 'e.g. "A French software vendor specializing in industrial automation"', value: aiPrompt, onChange: (e) => setAiPrompt(e.target.value) }), _jsxs("div", { className: "modal-ai-row", children: [_jsx("button", { type: "button", className: "btn-primary", disabled: aiBusy || !aiPrompt.trim(), onClick: handleGenerate, children: aiBusy ? "Generating…" : "Generate" }), aiError && _jsx("span", { className: "modal-ai-error", children: aiError }), !aiError && (_jsx("span", { className: "muted", style: { fontSize: 12 }, children: "Drafts will populate the fields below \u2014 you can edit before saving." }))] })] }), _jsx("div", { className: "modal-divider", children: _jsx("span", { children: "or fill manually" }) }), _jsxs("form", { onSubmit: handleSubmit, className: "modal-form", children: [_jsxs("label", { className: "modal-label", children: ["Concept name", _jsx("input", { className: "modal-input", autoFocus: true, value: name, onChange: (e) => setName(e.target.value), required: true })] }), _jsxs("label", { className: "modal-label", children: ["Concept type", _jsx("select", { className: "modal-input", value: conceptType, onChange: (e) => setConceptType(e.target.value), required: true, children: typeNames.map((t) => (_jsx("option", { value: t, children: t }, t))) })] }), _jsxs("label", { className: "modal-label", children: ["Definition (optional)", _jsx("textarea", { className: "modal-input", rows: 3, value: description, onChange: (e) => setDescription(e.target.value) })] }), _jsxs("div", { className: "modal-actions", children: [_jsx("button", { type: "button", className: "btn-ghost", onClick: onClose, disabled: busy, children: "Cancel" }), _jsx("button", { type: "submit", className: "btn-primary", disabled: !canSubmit, children: busy ? "Creating…" : "Create" })] })] }), _jsx("style", { children: `
